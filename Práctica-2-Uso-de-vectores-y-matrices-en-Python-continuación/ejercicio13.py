# Ejercicio 13: 
# Crear un sistema de inventario usando diccionarios: 
# Instrucciones: 
# • Crear un diccionario donde las claves sean nombres de productos 
# • Los valores deben ser diccionarios con: precio, cantidad, categoría 
# • Crear al menos 5 productos diferentes 
