# Ejercicio 14: 
# Crear un diccionario de contactos con funciones básicas: 
# Instrucciones: 
# • Crear un diccionario vacío llamado contactos 
# • Agregar 5 contactos con: nombre, teléfono, email 
# • Crear funciones para:  
# o Agregar un nuevo contacto 
# o Buscar un contacto por nombre 
# o Mostrar todos los contactos 
# o Eliminar un contacto 
# o Actualizar información de un contacto 
